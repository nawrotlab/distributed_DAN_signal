...
def build_model(params):
    ...
    w_MBON_DAN = Uniform(params['w_MBON_DAN'][0], params['w_MBON_DAN'][1]).get_value()
    ...
    # DAN
    # a single PAM DAN is modeled to represent the full cluster (bl*4)
    DAN_PAM_temp = Neuron(
        parameters="""
            b = """+str(params['b_PAM'])+"""
    ...
    # Model 4: MBON-DAN feedback; inhibitory within compartment, excitatory between compartment
    syns['MBONn_DAN_PAM'] = Projection(pre=pops['MBONn'],post=pops['DAN_PAM'],target='inh').connect_all_to_all(-w_MBON_DAN)
    syns['MBONp_DAN_PAM'] = Projection(pre=pops['MBONp'], post=pops['DAN_PAM'], target='exc').connect_all_to_all(w_MBON_DAN)

    syns['MBONn_DL1c1'] = Projection(pre=pops['MBONn'], post=pops['DAN_c1'], target='exc').connect_all_to_all(w_MBON_DAN/4)
    syns['MBONp_DL1c1'] = Projection(pre=pops['MBONp'][0], post=pops['DAN_c1'], target='inh').connect_all_to_all(-w_MBON_DAN)
    syns['MBONn_DL1d1'] = Projection(pre=pops['MBONn'], post=pops['DAN_d1'], target='exc').connect_all_to_all(w_MBON_DAN/4)
    syns['MBONp_DL1d1'] = Projection(pre=pops['MBONp'][1], post=pops['DAN_d1'], target='inh').connect_all_to_all(-w_MBON_DAN)
    syns['MBONn_DL1f1'] = Projection(pre=pops['MBONn'], post=pops['DAN_f1'], target='exc').connect_all_to_all(w_MBON_DAN/4)
    syns['MBONp_DL1f1'] = Projection(pre=pops['MBONp'][2], post=pops['DAN_f1'], target='inh').connect_all_to_all(-w_MBON_DAN)
    syns['MBONn_DL1g1'] = Projection(pre=pops['MBONn'], post=pops['DAN_g1'], target='exc').connect_all_to_all(w_MBON_DAN/4)
    syns['MBONp_DL1g1'] = Projection(pre=pops['MBONp'][3], post=pops['DAN_g1'], target='inh').connect_all_to_all(-w_MBON_DAN)
