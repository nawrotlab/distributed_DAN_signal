...
from m5_model import build_model
from m5_parameters import params
...
# creates and compiles parent model for parallelization
import platform
...
#
#
# fig1c, axes = plt.subplots(1, tight_layout=True)
# fig1c.text(0.4, 0.985, '1M NaCl', ha='center', fontsize=6, color='black')
# axes.plot(DAN_c1_rate,color='#9966FF', label='DAN c1')
# axes.plot(DAN_d1_rate,color='black', label='DAN d1')
# axes.plot(DAN_f1_rate,color='#33CB32', label='DAN f1')
# axes.plot(DAN_g1_rate,color='#008001', label='DAN g1')
# axes.plot(DAN_PAM_rate,color='#618ccf', label='1 DAN pPAM')
# axes.legend()
# #axes.plot(readout)
# axes.axhline(0.0, color='black', linestyle='--', alpha=0.2, linewidth=1)
# fig1c.subplots_adjust(wspace=1, hspace=0)
#
# fig1b, axes = plt.subplots(1, tight_layout=True)
# fig1b.text(0.4, 0.985, '1M NaCl', ha='center', fontsize=6, color='black')
# axes.plot(readout)
# axes.axhline(0.0, color='black', linestyle='--', alpha=0.2, linewidth=1)
# fig1c.subplots_adjust(wspace=1, hspace=0)
#
