...
def build_model(params):
    ...
    w_MBON_MBON = Uniform(params['w_MBON_MBON'][0], params['w_MBON_MBON'][1]).get_value()
    ...
    # model 3: Inhibitory interactions between MBONs of different valence
    syns['MBONn_MBONp'] = Projection(pre=pops['MBONn'], post=pops['MBONp'], target='inh')
    syns['MBONn_MBONp'].connect_all_to_all(weights=w_MBON_MBON)

    syns['MBONp_MBONn'] = Projection(pre=pops['MBONp'], post=pops['MBONn'], target='inh')
    syns['MBONp_MBONn'].connect_all_to_all(weights=w_MBON_MBON*4)
